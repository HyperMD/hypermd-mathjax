...
export class MathJaxRenderer implements MathRenderer {
  ...
  public _TypesetDoneCB(finished_expr) {
    if (this._cleared) {
      return;
    }
...
if (typeof MathJax !== "object") {
  ...
  console.error("[hypermd-mathjax] MathJax not found.")
} else if (0 == MathJax.Hub.config.jax.length) {
  // IF NOT FOUND, throw a warning
  console.error("[hypermd-mathjax] MathJax is not configured. See https://github.com/HyperMD/hypermd-mathjax#README")
